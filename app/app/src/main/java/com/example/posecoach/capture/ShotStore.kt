...
class ShotStore private constructor(val sessionDir: File) {
    ...
    /**
     * CẮT ẢNH VỀ ĐÚNG TỈ LỆ ẢNH MẪU trước khi ghi.
     *
     * ⚠️ Phải khớp với lớp che trên khung xem trước VÀ với phép cắt trước khi đo
     * (`PoseFrame.croppedToAspect`). Ba chỗ này mà lệch nhau thì người dùng canh
     * theo một khung, app chấm theo khung thứ hai, và nhận về bức ảnh khung thứ ba.
     *
